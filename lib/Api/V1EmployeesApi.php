...
class V1EmployeesApi
{
    ...
    public function createEmployeeWithHttpInfo($body)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\SquareConnect\Model\V1Employee', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\SquareConnect\Model\V1Employee', $e->getResponseHeaders());
    ...
    public function createEmployeeRoleWithHttpInfo($employee_role)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\SquareConnect\Model\V1EmployeeRole', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\SquareConnect\Model\V1EmployeeRole', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
    ...
    public function createTimecardWithHttpInfo($body)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\SquareConnect\Model\V1Timecard', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\SquareConnect\Model\V1Timecard', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
    ...
    public function listCashDrawerShiftsWithHttpInfo($location_id, $order = null, $begin_time = null, $end_time = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\SquareConnect\Model\V1CashDrawerShift[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\SquareConnect\Model\V1CashDrawerShift[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
    ...
    public function listEmployeeRolesWithHttpInfo($order = null, $limit = null, $cursor = null)
    {
        if (!is_null($limit) && ($limit > 200)) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling V1EmployeesApi.listEmployeeRoles, must be smaller than or equal to 200.');
        }
    ...
    {
        if (!is_null($limit) && ($limit > 200)) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling V1EmployeesApi.listEmployees, must be smaller than or equal to 200.');
        }
    ...
    public function listTimecardEventsWithHttpInfo($timecard_id)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\SquareConnect\Model\V1TimecardEvent[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\SquareConnect\Model\V1TimecardEvent[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
    ...
    {
        if (!is_null($limit) && ($limit > 200)) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling V1EmployeesApi.listTimecards, must be smaller than or equal to 200.');
        }

...
class V1PhoneNumber implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1PhoneNumber';
    ...
    {
        $this->container['calling_code'] = isset($data['calling_code']) ? $data['calling_code'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['calling_code'] === null) {
            $invalid_properties[] = "'calling_code' can't be null";
        }

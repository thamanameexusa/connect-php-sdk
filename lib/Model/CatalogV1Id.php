 ...
 *
 * @category    Class
 * @description An Items Connect V1 object ID along with its associated location ID.
 * @package     SquareConnect
...
class CatalogV1Id implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CatalogV1Id';
    ...
    {
        $this->container['catalog_v1_id'] = isset($data['catalog_v1_id']) ? $data['catalog_v1_id'] : null;
    ...
    {
        return $this->container['catalog_v1_id'];
    }
    ...
    {
        $this->container['catalog_v1_id'] = $catalog_v1_id;

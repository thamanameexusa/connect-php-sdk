...
class CatalogCategory implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CatalogCategory';
    ...
    public function setName($name)
    {
        ...
        if ((strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CatalogCategory., must be bigger than or equal to 1.');
        }
